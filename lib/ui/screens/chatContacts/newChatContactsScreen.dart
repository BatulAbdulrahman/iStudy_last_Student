...
void initState() {
  ...
  if (authState is Authenticated) {
    ...
    // Handle OTP sent state (e.g., for parent users)
    debugPrint(
        "OTP Sent: Mobile - ${authState.mobile}, OTP - ${authState.otp}");
    // You might want to navigate to an OTP verification screen or update UI
    // For now, we just print and allow the parent flow to continue.
  } else {
    // Handle other cases like Unauthenticated
    debugPrint("User is not authenticated or in an unsupported state.");
  }
}
