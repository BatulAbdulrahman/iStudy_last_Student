          ...
          PositionedDirectional(
            ...
            child: Container(
              ...
              child: Container(
                ...
                child: CustomUserProfileImageWidget(profileUrl: image),
              ),
            ),
          ),
          Column(
            ...
            children: [
              ...
              _buildGuardianDetailsTitleAndValue(
                ...
                context: context,
                value: Utils.formatEmptyValue(fullName),
              ),
              _buildGuardianDetailsTitleAndValue(
                context: context,
                title: Utils.getTranslatedLabel(emailKey),
                value: Utils.formatEmptyValue(email),
              ),
              mobile.isEmpty
                  ? const SizedBox()
                  : _buildGuardianDetailsTitleAndValue(
              ...
              currentAddress.isEmpty
                  ...
                  : _buildGuardianDetailsTitleAndValue(
                      ...
                      value: Utils.formatEmptyValue(currentAddress),
                    ),
              const SizedBox(
                height: 20,
              ),
